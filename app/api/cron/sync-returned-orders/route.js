...
import { cancelOrderOnShopify } from "@/app/lib/shopifySync.js";
...
export async function GET() {
  ...
  try {
    // Get all returned orders not yet synced with Shopify
    ...
    for (const order of orders) {
      ...
      try {
        const syncedOrder = await cancelOrderOnShopify(
          shopifyOrderId,
        ...
        if (syncedOrder) {
          await prisma.order.update({
            ...
            data: {
              ...
              shopifySyncStatus: "RETURNED",
              shopifyLastSyncAt: new Date(),
              remarks: {
                push: "Cancelled on Shopify",
              },
            },
          });
